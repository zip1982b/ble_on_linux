...
def start_notifications():
    ...
    bus.add_signal_receiver(temperature_received, dbus_interface = bluetooth_constants.DBUS_PROPERTIES,
            signal_name = "PropertiesChanged", path = temp_characteristic_path, path_keyword = "path")
    try:
...
if(len(sys.argv) != 2):
    print("usage: ./client_monitor_temperature.py [bdaddr]")
    sys.exit(1)
